...
// ambil artikel yg publish dan edited
...
$artikel = ($hasil) ? pg_fetch_all($hasil) : [];
?>
                ...
                <?php foreach ($artikel as $row): ?>
                    <div class="col-md-4">
                        <div class="card h-100 shadow border-0 hover-shadow">
                            ...
                            ?>
                            <img src="<?php echo htmlspecialchars($img_src); ?>"class="card-img-top" alt="<?php echo htmlspecialchars($row['judul']); ?>"style="height: 200px; object-fit: cover;">
