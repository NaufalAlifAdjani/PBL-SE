...
class personil_controller
{
    ...
    public function index()
    {
        ...
        $viewPath = __DIR__ . '/../views/personil/index.php';
    ...
    public function form()
    {
        ...
        $viewPath = __DIR__ . '/../views/personil/form.php';
        if (!file_exists($viewPath)) {
            die('View tidak ditemukan: ' . $viewPath);
        }
    ...
    public function save()
    {
        ...
        header('Location: manage_personil.php?status=saved');
        exit;
    }

    // ============================
    // DETAIL DOSEN (DEBUG ADMIN)
    // ============================
    ...
    public function delete_dosen()
    {
        ...
        header('Location: manage_personil.php?status=deleted_dosen');
        exit;
    }
    ...
    public function delete_member()
    {
        ...
        header('Location: manage_personil.php?status=deleted_member');
        exit;
    }
    ...
    public function form_member()
    {
        ...
        $viewPath = __DIR__ . '/../views/personil/formMember.php';
        if (!file_exists($viewPath)) {
            die('View tidak ditemukan: ' . $viewPath);
        }
    ...
    public function update_member()
    {
        ...
        header('Location: manage_personil.php?status=saved_member');
        exit;
    }
}
