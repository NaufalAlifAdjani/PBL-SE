...
<head>
    ...
    <link rel="stylesheet" href="/PBL BARU/pbl/assets/css/style.css"> 
...
<nav class="navbar navbar-expand-lg navbar-light">
    <div class="container">
        ...
        <a class="navbar-brand" href="/PBL BARU/pbl/index.php">Lab SE</a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item"><a class="nav-link" href="/PBL BARU/pbl/index.php">Landing Page</a></li> 
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownProfile">
                        ...
                        if ($dropdown_items && pg_num_rows($dropdown_items) > 0) {
                            while($item = pg_fetch_assoc($dropdown_items)) {
                                echo '<li><a class="dropdown-item" href="/PBL BARU/pbl/page.php?slug=' . htmlspecialchars($item['slug']) . '">' . htmlspecialchars($item['title']) . '</a></li>';
                            }
                        } else {
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownPersonil">
                        <li><a class="dropdown-item" href="/PBL BARU/pbl/personil.php">Lihat Semua Personil</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <?php
                        if ($personil_items && pg_num_rows($personil_items) > 0) {
                            while($p_item = pg_fetch_assoc($personil_items)) {
                                // echo '<li><a class="dropdown-item" href="/PBL BARU/pbl/personil.php#personil-' . $p_item['id_dosen'] . '">' . htmlspecialchars($p_item['nama_dosen']) . '</a></li>';
                                echo '<li><a class="dropdown-item" href="/PBL BARU/pbl/personil.php#personil-dosen-' . $p_item['id_dosen'] . '">' . htmlspecialchars($p_item['nama_dosen']) . '</a></li>';
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownGeeks">
                        <li><a class="dropdown-item" href="/PBL BARU/pbl/se_geeks.php">List Anggota</a></li>
                        <li><a class="dropdown-item" href="/PBL BARU/pbl/pendaftaran.php">Pendaftaran Baru</a></li>
                    </ul>
                </li>
        ...
        <a href="/PBL BARU/pbl/admin/index.php" class="btn btn-login px-3 py-2">Login</a>
    </div>
</nav>
