...
<head>
    ...
    <link rel="stylesheet" href="assets/css/userPersonil.css">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item"><a class="nav-link" href="../pbl/index.php">Home</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownPersonil">
                        <li><a class="dropdown-item" href="/PBL-NEW/pbl/personil.php#bagian-dosen">Lihat Semua Dosen</a></li>
                        <li><a class="dropdown-item" href="/PBL-NEW/pbl/personil.php#bagian-member">Lihat Semua Member</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="../pbl/blog.php">Blog Artikel</a></li>
            </ul>
        </div>
