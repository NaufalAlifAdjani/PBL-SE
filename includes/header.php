        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <?php if ($is_recruitment_open): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($current_page == 'recruitment.php' || $current_page == 'recruitment.php') ? 'active' : ''; ?>" href="https://localhost/PBL-TRY/PBL-SE/recruitment.php">Recruitment</a>
                    </li>
                <?php endif; ?>
